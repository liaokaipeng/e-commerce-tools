...
//   client/sign.js      签名与 query 组装（signedCall / refreshVia 共用同一套口径）
...
//   client/refresh.js   refreshVia：刷新 token 协议（按店铺 / 按商户整组）
//   client/plan.js      planRefresh：刷新分组决策（纯函数）
//   client/persist.js   刷新结果写回与分组失效标记
