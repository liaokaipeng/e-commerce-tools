  ...
  <div class="page">
    <div class="container">
      <VideoSteps
        ...
        :map-path="table.mapPath.value"
        :map-caption="table.mapCaption.value"
        :map-product="table.mapProduct.value"
        :show-mapping="table.showMapping.value"
        ...
        @update:map-path="(v) => (table.mapPath.value = v)"
        @update:map-caption="(v) => (table.mapCaption.value = v)"
        @update:map-product="(v) => (table.mapProduct.value = v)"
        @update:upload-ref="(v) => (uploadWidget = v)"
        @mapping-change="table.onMappingChange"
